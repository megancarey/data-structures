 ...
 * associates string keys with arbitrary data object references (you
 * don't need to copy the object). Your data structure should be 
 * optimized for algorithmic runtime and memory usage. You should 
 * not import any external libraries, and may not use primitive hash 
 * map or dictionary types in languages like Python or Ruby.
 *
 * Use only primitive types: boolean, byte, char, short, int, long,
 * float, and double.
 **/
